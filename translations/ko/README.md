...
{
  "original_hash": "25b44c9c44176aa1144cddc4afc9327f",
  "translation_date": "2025-11-17T02:57:59+00:00",
...
- 사용자 지정 User-Agent 헤더는 설정하지 않습니다 (요청을 최소화하기 위함).

## 문제 해결

- 404: API 키는 유효할 수 있으나, 엔드포인트/경로나 모델 이름이 잘못되었을 가능성이 큽니다. 엔드포인트를 확인하세요 (예: `/v1`이 한 번만 포함되어야 함) 및 모델 이름도 점검하세요.
- 401/403: 인증 또는 권한 오류입니다. API 키와 계정 접근 권한을 확인하세요.
