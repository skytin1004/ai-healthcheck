...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-11-17T03:03:32+00:00",
...
환경 변수 예시로 자격 증명을 설정한 후, 체크를 호출하세요.
...
- 401/403: 인증 또는 권한 오류. API 키와 계정 접근 권한을 확인하세요.

## CI/CD 및 시작 프로브

파이프라인이나 앱 시작 시 이 체크를 사용해 빠르게 실패하고 명확한 안내를 받을 수 있습니다.
